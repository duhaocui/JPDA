...
for k=2:NT
    ...
    tic
    [xf,Pf]=propagate_JPDA(xf,Pf,SIM,Tvec,k-1,k,Q,No,f,fn,name);
    toc
    ...
    if L>0
        ...
        tic
        [xf,Pf,JPDAprops]=MeasurementUpdate_JPDA(xf,Pf,SIM,ymset,k,R,No,h,hn,JPDAprops,name);
        toc
    else
